...
import com.ruleengine.rule.DecisionTree;
import com.ruleengine.rule.model.data.ConditionType;
import com.ruleengine.rule.model.data.RuleCondition;
import com.ruleengine.rule.model.tree.Signal;
import com.ruleengine.rule.model.tree.ValueType;
...
public class SignalDecisionTree implements DecisionTree {
	...
	public boolean violatesAnyRule(SignalSource querySignal) {
		...
		Signal signalFromTree = signalsRoot.get(querySignal.getSignal());

		if (signalFromTree == null)
			return false;

		switch (querySignal.getValue_type()) {
